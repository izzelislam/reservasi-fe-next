          ...
          <div className='border-1 border-gray-300 rounded-lg p-4'>
            ...
            <div className='w-full md:w-1/2 mb-6'>
              <div className='flex justify-between items-center mb-2'>
                ...
                {
                  room?.status === 'booked' &&
                  <span className='text-sm bg-green-600 px-2 py-1 rounded-full text-white'>
                    Terverifikasi
                  </span>
                }
                ...
                {
                  room?.status === 'pending' &&
                  <span className='text-sm bg-orange-400 px-2 py-1 rounded-full text-white'>
                    Pending
                  </span>
                  }
                  {
                  room?.status === 'canceled' &&
                  <span className='text-sm bg-red-400 px-2 py-1 rounded-full text-white'>
                    dibatalkan
                  </span>
                  }
                  {
                  room?.status === 'finished' &&
                  <span className='text-sm bg-blue-600 px-2 py-1 rounded-full text-white'>
                    selesai
                  </span>
                  }
              </div>
