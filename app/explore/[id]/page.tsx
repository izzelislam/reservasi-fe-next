  ...
  return (
    <div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-10 block md:hidden p-4 drop-shadow-[0_0px_22px_rgba(0,0,0,0.50)] bg-white rounded-t-lg">
        ...
        <Button onClick={() => handleBooking()}  isDisabled={!selectEndDate && !selectStartDate} color='primary' fullWidth className="text-center" startContent={<Icon icon="solar:box-bold-duotone" fontSize={20} />} size="md">Booking Sekarang</Button>
